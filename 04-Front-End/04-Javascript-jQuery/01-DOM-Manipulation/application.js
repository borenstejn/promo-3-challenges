...
function run_challenges() {
  ...
  var email_input = $('#email').val('jeromeborenstejn@gmail.com');




  // Ex 3. Replace the email hint (next to the input) with 'This is my email now'
  //       The text should be emphasized using a <strong> tag'email-hint'
  var hint_input = $('#email-hint').html('<strong>This is my email now</strong>');
  ...
  $('.table').append('<tr><td>15</td><td>My Team</td><td>0</td></tr>');
